...
export function openModal (modal, token,  tokenIndex, lock, proposalId, selectionLayer, destNetworkSelection) {
  return function (dispatch) {
    return dispatch({ type: 'UI/MODAL/OPEN', payload: modal, token, tokenIndex, lock, proposalId, selectionLayer, destNetworkSelection });
  }
}
