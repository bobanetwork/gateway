import { Popover, PopoverTrigger, PopoverContent, Button, Text } from "@/components/ui"
    ...
    <Popover>
      ...
      <PopoverContent className="w-[350px]" align="end">
        <div className="grid gap-4">
          ...
          <div className="flex flex-col gap-2 divide-y max-h-[500px] overflow-auto">
            {[1, 2].map((i) => (<div key={i} className="p-2 max-w-sm mx-auto flex items-start space-x-4">
