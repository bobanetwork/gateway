...
import { Option, MultiValue, SingleValue } from './Custom.select'
...
function Select({
  ...
  const renderLoading = (
    <S.SelectedContainer
      className={[styles.selected, styles.loading].join(' ')}
    >
      Loading...
    </S.SelectedContainer>
  )
        ...
        MenuProps={{
          sx: {
            '&& .Mui-selected': {
              ...
              color:
                styledTheme.name === 'light'
                  ? styledTheme.colors.gray[600]
                  : styledTheme.colors.gray[100],
            },
          },
        }}
      >
  ...
  if (newSelect) {
    return (
      <Box className={[styles.Select, className].join(' ')}>
        ...
        <ReactSelect
          ...
          styles={{
            menu: (base) => ({
              ...
              background:
                styledTheme.name === 'light'
                  ? styledTheme.colors.gray[50]
                  : styledTheme.colors.gray[400],
              borderRadius: '8px',
              zIndex: 100,
            }),
  ...
  return (
    <div className={[styles.Select, className].join(' ')}>
      ...
      <S.Field>{loading ? renderLoading : renderSelect}</S.Field>
    </div>
  )
}
