...
export const bnbConfig: NetworkDetail = {
  ...
  Mainnet: {
    ...
    L2: {
      ...
      chainId: 56288,
      chainIdHex: '0xDBE0',
      rpcUrl: [`https://bnb.boba.network`, `https://replica.bnb.boba.network`],
      blockExplorer: `https://bnb.bobascan.com/`,
      transaction: `https://bnb.bobascan.com/tx/`,
      blockExplorerUrl: `https://bnb.bobascan.com/`,
      symbol: 'BOBA',
      tokenName: 'Boba Token',
    },
    gasEstimateAccount: `0xdb5a187FED81c735ddB1F6E47F28f2A5F74639b2`,
